...
In this project, I **import essential libraries** that play  roles in  data manipulation and visualization :
...
My project begins with **loading data** from CSV files using the **pandas** library, segregating the data into train  datasets. These datasets contain crucial information about the Titanic passengers, forming the foundation of my analysis.
